...
export type DropdownTrigger = "button" | "filter" | "field";
...
const isItem = (e: DropdownEntry): e is DropdownItem => !("divider" in e);
...
export function Dropdown({
  ...
  useLayoutEffect(() => {
    ...
    const place = () => {
      ...
      const want = alignment === "right" ? r.right - w : r.left;
  ...
  }, [open, alignment, menuId, menuWidth]);
