import styles from "./ProgressLegacy.module.css";

export type ProgressLegacyLabelPosition = "center" | "right";
...
export interface ProgressLegacyProps {
  ...
  valueLabel?: string;
  showLabel?: boolean;
  labelPosition?: ProgressLegacyLabelPosition;
}

// Figma progress-bar 3013:5958 (legacy): a 20-tall neutral track, a blue fill, and the value on or after the bar.
export function ProgressLegacy({ value, label = "Progress", valueLabel, showLabel = true, labelPosition = "center" }: ProgressLegacyProps) {
