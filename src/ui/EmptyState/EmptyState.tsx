...
export type EmptyStateIconStyle = "well" | "plain";
...
export function EmptyState({ title, description, icon, iconStyle = "well", media, actions, outlined = false, headingLevel = 3 }: EmptyStateProps) {
