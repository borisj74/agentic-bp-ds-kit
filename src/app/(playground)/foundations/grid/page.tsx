...
export default function GridSystems() {
  return (
    <>
      ...
      <p className={shell.pageMeta}>Viewport widths 1280, 1440 and 1920 come from BP Foundations. Gutters and margins use BP spacing steps. The rest is kit-defined.</p>
